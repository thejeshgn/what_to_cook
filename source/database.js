APP.database = (function () {
    ...
    function open(successCallback) {
        smallDatabase = openDatabase("APP2", "1.0", "WHAT2COOK", (5 * 1024 * 1024));
        runQuery("CREATE TABLE IF NOT EXISTS articles(id TEXT PRIMARY KEY, name TEXT, description TEXT, ingredients TEXT, steps TEXT, credit TEXT)", [], successCallback);
    }
    return {
        open: open,
        runQuery: runQuery
